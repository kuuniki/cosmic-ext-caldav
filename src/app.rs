...
impl Application for App {
    ...
    fn update(&mut self, message: Self::Message) -> Task<Self::Message> {
        match message {
            ...
            Message::UsernameChanged(v) => self.username_input = v,
            ...
            Message::CalendarsLoaded(_, result) => {
                self.is_loading = false;
                match result {
            ...
            Message::EventsLoaded(_, _, result) => {
                self.is_loading = false;
                match result {
                    Ok(mut evts) => {
        ...
        widget::settings::item(
            ...
            widget::row::with_children(vec![
                widget::button::standard("Calendars")
                    .on_press(Message::ViewCalendars(id))
                    .into(),
                widget::button::destructive("Remove")
                    .on_press(Message::DeleteAccount(id2))
                    .into(),
            ])
            .spacing(8),
        )
